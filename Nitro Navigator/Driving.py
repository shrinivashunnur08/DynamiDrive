...
while True:
    ...
    colourLower = np.array([99, 60, 233])
    ...
    cv2.putText(img,'Left',(110,30),cv2.  FONT_HERSHEY_COMPLEX,1,(0,0,255))

    img = cv2.rectangle(img,(width//2 + 35,0),(width-2,height//2 ),(0,255,0),1)
    cv2.putText(img,'Right',(440,30),cv2.  FONT_HERSHEY_COMPLEX,1,(0,0,255))
